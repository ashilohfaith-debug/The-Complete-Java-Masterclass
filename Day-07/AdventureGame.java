...
public class AdventureGame {
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to Hemlock Grave 💀");
        System.out.println("Your goal is to find the hidden treasure. Choose wisely 👀");

        System.out.println("You are at a crossroad. Do you want to go left ↖️ or right ↗️ ?");
        ...
        switch (choice1) {
            case "left":
                ...
                switch (choice2) {
                    case "enter":
                        System.out.println("As you enter the cave, bats 🦇 fly out! Inside the cave, you find a sleeping dragon 🐉 !");
                        ...
                        switch (choice3) {
                            ...
                            case "sneak":
                                ...
                                break;
                            default:
                                System.out.println("Invalid choice. You got caught by the dragon. Game over 🩸");
                                break;
                        }
                        break;
                    case "walk":
                        System.out.println("You walk past the cave and fall 🕳️ into a hidden trap. Game over 🩸");
                        break;
                    default:
            ...
            case "right":
                ...
                String choice2b = sc.nextLine().toLowerCase();

                switch (choice2b) {
                    case "swim":
                        System.out.println("You swim 🏊 across the river and encounter a wild bear 🐻 !");
                        System.out.println("Do you want to run away 🏃‍➡️ or climb 🧗 a tree?");
                        System.out.print("Type 'run' or 'climb': ");
                        String choice3b = sc.nextLine().toLowerCase();

                        switch (choice3b) {
                            case "run":
                                System.out.println("You run away 🏃‍➡️ safely and find a hidden path to the treasure. You win 💰 !");
                                break;
                            case "climb":
